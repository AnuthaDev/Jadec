...
import com.thesourceofcode.jadec.utils.ktx.appStorage
import com.thesourceofcode.jadec.utils.ktx.cleanMemory
import com.thesourceofcode.jadec.utils.streams.ProgressStream
    ...
    companion object {
        ...
        fun isAvailable(decompiler: String): Boolean {
            return when (decompiler) {
                "procyon" -> true
                "cfr" -> true
                "jadx" -> Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP
                "fernflower" -> true
                else -> false
            }
        }
